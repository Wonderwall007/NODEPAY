...
hju = Fore.CYAN  # You can change the color as you like
mrh = Fore.YELLOW  # You can change the color as you like
pth = ""  # If needed, define this too for your print statements

def log_line():
    print("-" * 50)

def banner():  # No indentation
    banner_text = r"""   
                        ⚒️ AIRDROP FAMILY IND🤖
    """

    print(Fore.GREEN + Style.BRIGHT + banner_text + Style.RESET_ALL)
    print(hju + f"JOIN @AirDropFamilyIND ")
